...
#@SanityTest
Scenario: verify the InfoTech_cloud sigin page with valid_Mobile_Number and valid_Mobile_Password credentials
  Given open the valid url in InfoTech_cloud application
  Then Enter the  usernamesdsdsds in username field "testmani2@1.com"
  Then Enter the valid passwordsdsd in password field "1"
  Then click the submit button
  Then click the Administration 
  Then click the Email2fA settings
...
#@SanityTest
Scenario: verify the InfoTech_cloud sigin page with Employee login confirmation
  Given open the valid url in InfoTech_cloud application
  Then Enter the  usernamesdsdsds in username field "testmani2@1.com"
  Then Enter the valid passwordsdsd in password field "1"
  Then click the submit button
  ...
  And Verify the Employee login successfully
...
#Scenario: verify the InfoTech_cloud sigin page with Links on Login page should redirect to the respective page
  ...
  #@SanityTest
  Scenario: verify the Termination Employee login
    Given open the valid url in InfoTech_cloud application
    Then Enter the  usernamesdsdsds in username field "testtermination02@1.com"
    Then Enter the valid passwordsdsd in password field "1"
    Then click the submit button
    And verify the applicatisdfsfdsondgdgdd not  successfully.
