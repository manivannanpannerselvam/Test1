...
Feature: verify Employee_Basic_Details_Positive_flow
  ...
  @SanityTest
  Scenario Outline: verify the Positive flow in E-claims modules
    ...
    And verify the Eclaim  software application is visible properly
    ...
    Then Enter the Fin id number "Tsdsdsd"
    Then click the E-claim App Access
    Then click the E-claim button
    Then select the claim Date Range name "Test01"
    Then select the claim Date "Test001"
    Then Select the final Approver in Eclaim "testmani2"
    ...
    Examples: 
      ...
      | mani005   | manikandan  | MALE   | Single        | manikandan@mailinator.com |     96666665 | 12-12-2018 | S9247710Z  | testmani2 |
