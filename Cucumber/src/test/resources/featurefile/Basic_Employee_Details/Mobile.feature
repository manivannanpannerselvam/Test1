...
Feature: verify Employee_Basic_Details_Positive_flow
  ...
  @SanityTest
  Scenario Outline: verify the Positive flow in Mobile Module
    ...
    Then Enter the Fin id number "ayyapan002"
    ...
    Examples: 
      ...
      | ayyapan002  | ayyaps | MALE   | Single        | ayyaps@mailinator.com |     96666620 | 12-12-2018 | S9247710Z  | testmani2 |
