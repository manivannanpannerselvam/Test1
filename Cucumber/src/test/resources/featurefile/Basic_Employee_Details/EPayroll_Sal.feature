...
Feature: verify Employee_Basic_Details_Negative_Scenario
  ...
  @SanityTest
  Scenario Outline: verify salary mode is 100 percentage
    ...
    Then Enter the Fin id number "FDSF32"
    ...
    Examples: 
      ...
      | fifth0001     | fifthEmps    | MALE   | Single        | fifth@mailinator.com |     96666614 | 12-12-2018 | S9247710Z  | testmani2 |
