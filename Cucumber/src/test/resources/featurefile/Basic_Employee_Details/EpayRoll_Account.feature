...
Feature: verify Employee_Basic_Details_Positive_flow
  ...
  @SanityTest
  Scenario Outline: Create Employee with Bank Details in payroll App
    ...
    Then Enter the Fin id number "Tsdsd"
    ...
    Examples: 
      ...
      | mani077    | manibala  | MALE   | Single        | manibala@mailinator.com |     96666668 | 12-12-2018 | S9247710Z  | testmani2 |
