...
Feature: verify payroll initialize
  ...
  Scenario Outline: Check for the display and list of employees based on the Department
    ...
    Then change the login month "February"
    ...
    Then Edit the Termination date for payroll "02-02-2019"
    ...
    Examples: 
      ...
      | Termination_user | TerminationEmp | MALE   | Single        | TerminationEmp@gmail.com |     95525227 | 01-10-2018 | 30-10-2018      | S2427876Z  | testmani2 | D333   |
