...
Feature: verify payroll initialize
  ...
  Scenario Outline: Check for the display and list of employees based on the Department
    ...
    Then change the login Type "MID"
    ...
    Then Edit the Termination date for payroll "30-10-2018"
    ...
    Examples: 
      ...
      | Termidposit | Termpositmid | MALE   | Single        | TerminationPosmidEmp@gmail.com |     96521227 | 13-10-2018 | 25-10-2018      | S8273893B  | testmani2 | Termid006 |
