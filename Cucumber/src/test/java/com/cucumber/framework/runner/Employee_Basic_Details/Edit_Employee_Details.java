...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/Edit_Employee_Details.feature" }, glue = {
...
public class Edit_Employee_Details extends AbstractTestNGCucumberTests{
