...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/EpayRollEmployee_Type.feature" }, glue = {
...
public class EpayRollEmployee_Type extends AbstractTestNGCucumberTests
{
