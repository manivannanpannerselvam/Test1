...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/EpayrollPercentage.feature" }, glue = {
...
public class EpayrollPercentage extends AbstractTestNGCucumberTests
{
