...
@CucumberOptions(features = { "classpath:featurefile/UserAccess/UserAccess_Negative2.feature" }, glue = {
...
public class UserAccess_Negative2 extends AbstractTestNGCucumberTests{
