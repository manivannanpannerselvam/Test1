...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/EPayroll_Sal.feature" }, glue = {
...
public class EPayroll_Sal extends AbstractTestNGCucumberTests{
