...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/Duplicate_Employe_Details.feature" }, glue = {
...
public class Duplicate_Employe_Details extends AbstractTestNGCucumberTests{
