...
@CucumberOptions(features = { "classpath:featurefile/Basic_Employee_Details/EpayRollHourly.feature" }, glue = {
...
public class EpayRoll_HourlyRate extends AbstractTestNGCucumberTests {
