...
@CucumberOptions(features = { "classpath:featurefile/UserAccess/UserAccess_Negative.feature" }, glue = {
...
public class UserAccess_Negative extends AbstractTestNGCucumberTests{
